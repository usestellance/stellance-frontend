...
const Template05 = () => {
  ...
  return (
    <div className="mt-10 rounded-[5px]  pt-1.5 pb-10 sm:pt-4 lg:pt-6 invoice-shadow mx-auto md:rounded-[10px] lg:rounded-[20px] ">
      ...
      <section className=" flex justify-between mt-5 gap-10 md:mt-7 lg:mt-10">
        <div>
          <p className="px-2.5 sm:px-4 lg:px-5 tracking-[4px] bg-primary-20 py-2 font-medium text-base sm:text-2xl lg:text-4xl text-primary-500">
            INVOICE
          </p>
        </div>
  ...
  return (
    <div className="">
      <div className="overflow-x-auto scroll pb-4">
        <table className="  min-w-full border-collapse border-spacing-y2 overflow-hidden">
          <thead className=" overflow-hidden bg-primary-100">
            <tr className="">
              <th
                scope="col"
      ...
      <div className="bg-red400 w-full custom-container">
        <div className="flex justify-end py-[18px] md:mt-5">
      ...
      <div className="custom-container w-full flex flex-col items-end justify-end md:pt-4">
        <div className="w-full max-w-[273px] lg:max-w-8/12 flex justifybetween h-[43px] overflow-hidden items-center">
          <h5 className="text-sm font-bold leading-[25px] py-3 px-4 w-20 md:text-lg">
            TOTAL
          </h5>
          <h5 className="truncate w-full text-end text-sm font-bold leading-[25px] md:text-base lg:text-lg py-3">
            {formatCurrency(total || 0)}
          </h5>
        </div>

        <p className="text-xs font-medium text-end italic mt-2 md:mt-5 md:text-sm lg:text-base pb-4 md:pb-8">
