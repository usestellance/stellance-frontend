    ...
    <li>
      ...
      >
        <Icon
          ...
          } text-xl flex-shrink-0 lg:text-[28px]`}
        />
        <span className="text-xl font-medium lg:text-[24px]">{item.name}</span>
      </Link>
    </li>
  );
};
  ...
  return (
    <>
      ...
      <div
        ...
        } transition-transform duration-300 ease-in-out max-md:fixed relative h-screen left-0 top-0 bottom-0 bg-[#D9E4F8] w-full max-w-[280px] z-50 rounded-tr-[20px] rounded-br-[20px] md:rounded-tr-[10px] md:rounded-br-[10px] lg:max-w-[323px]  overflow-hidden flex flex-col`}
