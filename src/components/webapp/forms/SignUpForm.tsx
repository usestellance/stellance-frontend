...
import { loginValidation } from "../../../lib/validations/userValidations";
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="text-center text-xs text-primary dark:text-secondary mt-6 sm:text-lg sm:text-white">
