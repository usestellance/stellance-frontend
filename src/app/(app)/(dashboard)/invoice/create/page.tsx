    ...
    <section className="">
      <div className="myContainer">
        ...
        <div className="flex gap-[2px] items-center mt-[10px] md:mt-5">
          ...
          <div className=" border border[#AAAAAA] font-medium text-xs h-[30px] flex items-center px-[10px] py-[6px] rounded-[6px] min-w-[100px] md:h-[40px] lg:min-w-[150px] bg-[#D9E4F8] lg:h-[60px] lg:text-base lg:px-[22px]">
            INV-001
          </div>
        </div>
      </div>
